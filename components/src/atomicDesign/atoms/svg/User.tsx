...
import Flex, { FlexBoxLayoutPropsType, flexLayoutCenterPropsInit } from 'components/flexes';
  ...
  return (
    <Container {...p}>
      <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xmlSpace="preserve">
		...
		c-73.262,0-132.643,59.412-132.643,132.654C123.357,205.917,182.738,265.308,256,265.308z"></path>
          <path
		...
		c-21.55,22.956-51.628,71.991-57.551,107.465C71.573,480.444,164.877,512,256,512C347.123,512,440.427,480.444,425.874,393.104z"></path>
        </g>
      </svg>
    </Container>
  );
